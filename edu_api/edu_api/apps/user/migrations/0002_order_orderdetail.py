# Generated by Django 2.0.6 on 2020-07-18 17:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_courses', to='user.Order', verbose_name='订单ID')),
            ],
            options={
                'verbose_name': '订单详情',
