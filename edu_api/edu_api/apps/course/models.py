...
from course.BaseModle import BaseModel
...
class Course(BaseModel):
    ...
    course_video = models.FileField(upload_to='video', null=True, blank=True, verbose_name='学习视频')
    ...
    def brief_html(self):
        brief = self.brief.replace('src="/media', 'src="%s/media' % 'http://127.0.0.1:8000')
    ...
    def real_price(self):
        ...
        if len(active_list) > 0:
            """如果课程对应的活动存在，则根据课程所参见的活动规则来计算价格"""
            active = active_list[0]
